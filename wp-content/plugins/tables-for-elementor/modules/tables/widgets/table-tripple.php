...
class Table_Tripple extends Widget_Base {
	...
	public function get_name() {
		return 'tripple-table';
	}

	public function get_title() {
		return __( '3 Column Table', 'elementor-tables' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'column_3_title',
			[
				'label' => __( 'Third Title Settings', 'elementor-tables' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} #el-tables-tripple .table-cell:nth-child(2)' => 'outline: 1px solid {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} #el-tables-tripple .table-cell:nth-child(3)' => 'outline: 1px solid {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} #el-tables-tripple .table-cell:nth-child(4)' => 'outline: 1px solid {{VALUE}};',
				],
			]
		);
