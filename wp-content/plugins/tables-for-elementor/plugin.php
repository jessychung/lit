...
class Plugin {
	...
	public function get_version() {
		return ELEMENTOR_TABLES_VERSION;
	}
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'elementor-tables' ), '1.0.0' );
	}
	...
	private function _includes() {
		require ELEMENTOR_TABLES_PATH . 'includes/modules-manager.php';
	}
	...
	public function autoload( $class ) {
		...
		$filename = ELEMENTOR_TABLES_PATH . $filename . '.php';
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style(
			'elementor-tables',
			ELEMENTOR_TABLES_URL . 'assets/css/frontend' . $direction_suffix . $suffix . '.css',
			[],
	...
	public function elementor_init() {
		...
		\Elementor\Plugin::instance()->elements_manager->add_category(
			'table-elements',
			[
				'title' => __( 'Tables', 'elementor-tables' ),
				'icon' => 'font',
			],
			1
		);
...
if ( ! defined( 'ELEMENTOR_TABLES_TESTS' ) ) {
